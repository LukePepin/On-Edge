**ARCHIVED — superseded by `docs/system_architecture.md` and ground_truth.md; retained for history.** *(Note: `project_truth.md` §7 describes this file as an identical duplicate of the canonical system_architecture.md; it is in fact an older, more contaminated revision — Vault hashing, "verification < 400ms" trust logic, Category 0 halt. Archived rather than deleted.)*
