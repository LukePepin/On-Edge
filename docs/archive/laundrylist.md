...
## 2. Robotic Hardware
- [ ] **1x Universal Robots UR5**: 6-axis collaborative industrial manipulator. *(Note: Switched from Niryo to UR5 due to lab availability and native ROS 2 driver support, eliminating the need for a custom ROS bridge).*
- [ ] **1x Wrist-mounted 9-axis IMU**: (e.g., MPU-9250, BNO085, or similar breakout board) to record acceleration and deceleration curves. Needs wiring/mount to attach to the UR5 wrist.
...
- [ ] **Ethernet Cables (Cat6)**: Multiple cables to connect the Raspberry Pi, UR5 (if wired), and the out-of-band telemetry laptop/switch.
