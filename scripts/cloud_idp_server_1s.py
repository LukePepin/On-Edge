...
# Generates Mock JSON Web Tokens (JWT) with a strict 1.0-second lease
# (Reflects the Lease TTL Safety Paradox threshold)
...
class MockCloudIdP(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path == '/api/auth/lease':
            ...
            exp_time = current_time + 1 # 1.0 second TTL
